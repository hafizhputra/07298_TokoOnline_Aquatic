    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="#"><img src="assets/images/logo/kopa.png" alt="Logo"><h5>Aquatic</h5></a>
                        <h1 class="auth-title">Sign Up</h1>
                        <p class="auth-subtitle mb-5">Silahkan registrasi untuk mendaftar menjadi member Aquatic</p></p>
