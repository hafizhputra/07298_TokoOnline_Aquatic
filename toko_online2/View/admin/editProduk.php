                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="last-name-column" class="form-control" placeholder="Input Nama Kopi" value="<?= $data['nama_produk'] ?>" name="nama">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="country-floating" class="form-control" name="harga" placeholder="Input Harga Kopi" value="<?= $data['harga_produk'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="last-name-column">Stok produk</label>
                                                    <input type="text" id="last-name-column" class="form-control" placeholder="Input Nama Kopi" value="<?= $data['stok_produk'] ?>" name="stok">
                                                </div>
                                            </div>
