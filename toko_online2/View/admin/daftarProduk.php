                      ...
                      <div class="modal-content">
                        ...
                        <form action="index.php?page=admin&aksi=tambahProduk" method="POST" enctype="multipart/form-data" role="form">
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <select name="id_kategori" class="form-select" require>
                                <?php foreach ($kategori as $row) : ?>
                      ...
                      <tbody>
                        <?php foreach ($produk as $row) : ?>
                          <tr>
                            ...
                            <td><img src="upload/<?= $row['gambar_produk'] ?> " alt="<?= $row['nama_produk'] ?>" width="150" height="100"></td>
                            <td><?= $row['stok_produk'] ?></td>
                            <td>
                              <input type="hidden" name="namafoto" value="<?= $row['gambar_produk'] ?>">
                              <a href="index.php?page=admin&aksi=editProduk&id=<?= $row['id_produk'] ?>" class="btn btn-warning">Edit</a>
                              <a href="index.php?page=admin&aksi=hapusProduk&id=<?= $row['id_produk'] ?>" class="btn btn-danger">Hapus</a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
