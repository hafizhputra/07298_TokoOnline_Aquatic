...
<div class="container">
  <div class="row">
    <img src="assets/images/thumnail/aquatic1.png" style="border-radius: 50px;">
...
<div class="container">
  <div class="row">
    ...
    <br>
    <h3 class="card-text" >Kategori Pilihan</h3>
      ...
      <?php foreach ($kategori as $item) : ?>
        ...
        <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6" >
          <td >
            ...
            <div class="card" style="width: 15rem; background-color:#DFF6FF;" >
                 <a href="index.php?page=pelanggan&aksi=getKategoriByid&id=<?= $item['id_kategori'] ?>" class="btn">
...
<br>
  ...
  if ($_SESSION['username_member'] == 'OK') {
    echo "<script>
          Swal.fire(
            'Berhasil Login','',
            'success',
